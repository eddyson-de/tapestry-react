...
/**
 * Nashorn module loader get's inserted into java script and can load AMD modules from classpath
 *
...
public class NashornModuleLoader {
    ...
    public NashornModuleLoader(ScriptEngine engine,
                               ModuleManager moduleManager,
                               Bindings bindings,
                               StreamableResourceSource srs,
    ...
    public void loadModule(String name) throws IOException, ScriptException {
        ...
        if ("underscore".equals(name)) {
            resource =
                this.assetSource.getClasspathAsset("/META-INF/assets/tapestry5/underscore-1.8.3.js").getResource();
        }
        else {
        ...
        StreamableResource streamableResource =
            this.srs.getStreamableResource(resource, StreamableResourceProcessing.COMPRESSION_DISABLED, this.tracker);
